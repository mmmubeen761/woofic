  ...
  function SendLoginDetails(e) {
    ...
    if (password !== cpassword) {
      ...
      const { data: response } = axios.post(
        `http://woofic-api.nastechltd.co/api/provider`,
        {
        ...
        <div className="card card0 border">
          <div className="row d-flex ">
            <div className="col-lg-6 py-4">
              <h5><Link className="text-danger px-3" to="/client" >Customer</Link><Link className="text-danger px-3 p-2 shadow-sm border-3  rounded" to="/serviceprovider">Service Provider</Link><Link className="text-danger px-3 p-2" to="/supplier">Supplier</Link></h5>
